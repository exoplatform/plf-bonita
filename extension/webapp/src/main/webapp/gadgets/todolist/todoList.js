...
getList=function(xhr){
	...
	if(activityinstance.length!=0){
		...
		document.getElementById('mytasks_id').innerHTML = str;
	}else{
		document.getElementById('mytasks_id').innerHTML="<div class='NoneSpace'>"+eXo.social.Locale.getMsg('has_no_task')+"</div>";
	}
