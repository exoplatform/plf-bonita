...
function getProduct(version) {
  ...
  product.name = "exo.bonita" ;
  product.portalwar = "portal.war" ;
  product.codeRepo = "exo.bonita" ;
  ...
  var bonita = Module.GetModule("exo.bonita", {kernel : kernel, ws:ws, core : core, eXoJcr : eXoJcr, platform : platform});

  
  /* bonita */
  product.addDependencies(bonita.extension);
  product.addDependencies(bonita.portlet);
  product.addDependencies(bonita.web.bonita);
  product.addDependencies(bonita.web.bonitaServerRest);
  product.addDependencies(bonita.component.services);
  product.addDependencies(bonita.component.uiextension);
...
//  product.addDependencies(platform.crash.webapp);
  ...
  /* ECMS */
//remove all exo workflow component to allow luanch of process
...
//  product.addDependencies(workflow.extension.webapp);
  ...
  product.addServerPatch("tomcat", bonita.patch.tomcat) ;
...
//  product.removeDependency(new Project("commons-collections", "commons-collections", "jar", "2.1"));
  ...
  /* after using ecms 2.1.5-CP01, we need to remove some 2.1.5 dependancies*/
  product.removeDependency(new Project("org.exoplatform.ecms", "exo-ecms-core-parser", "jar", "2.1.5"));
  product.removeDependency(new Project("org.exoplatform.ecms", "exo-ecms-core-webui", "jar", "2.1.5"));
  product.removeDependency(new Project("org.exoplatform.ecms", "exo-ecms-ext-xcmis-sp", "jar", "2.1.5"));
  /* add exo-ecms-ext-xcmis-sp-2.1.5-CP01.jar*/
  product.addDependencies(new Project("org.exoplatform.ecms", "exo-ecms-ext-xcmis-sp", "jar", wcm.version));
