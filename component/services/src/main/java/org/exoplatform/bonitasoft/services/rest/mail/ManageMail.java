...
public class ManageMail implements ResourceContainer {
  ...
  public void sendMail(@FormParam("userName") String userName, @FormParam("link") String link,
      @FormParam("commentaires") String commentaires) throws Exception {
    ...
    String message = "<table cellspacing='0' cellpadding='0' border='0' width='550' style='max-width: 550px; border-top: 4px solid #FFD400; font: 12px arial,sans-serif; margin: 0pt auto;'><tbody><tr><td> "
        ...
        + ""
        + "</p>"
        + "Your Document  <a href='"
        + System.getProperty("org.exoplatform.runtime.conf.cas.server.name")
        + "/portal/private/intranet/editor?path="
        + link
        + "'>"
        + tab[tab.length - 1]
        + "</a> is valid.<br/>Look the last comments on your document :<br/><br/><FIELDSET><LEGEND align=top><b>Last Comments</b></LEGEND>"
        + "<div style=' max-height: 280px; max-width: 660px; overflow : auto;'>"
        + commentaires
        + "</div></FIELDSET>"
        + "</p>"
