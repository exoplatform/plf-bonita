...
public class ChangePublicationService {
  ...
  /**
   * this method allow to start the changePublication service to get the
   * list of node to change there publicationState
   * 
   * @param path
   * @param status
   */
  public void start(String path, String status) {
    ...
    try {
      ...
      PublicationService publicationService = (PublicationService) exoContainer
